/*
 * Program Description: Automotive class
  */
...
public class Driver extends Thread {
	...
	public static void main(String[] args) {
		...
		//----------text file names-----------
		//String f1 = "..\\..\\FocusWagonZTW.txt";
		String f3 = "..\\..\\HelloKitty.txt";
		...
		//myList.buildAuto(f4); //this is the file with missing auto name
		
		//print out all the autos in the list
		//print all the autos in the current inventory
		//myList.printAutos();
